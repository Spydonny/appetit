...
class PillButton extends StatelessWidget {
  const PillButton({
    ...
    required this.child, required this.colorPrimary, required this.colorOnPrimary,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return ElevatedButton(
      ...
      style: ButtonStyle(
        ...
        foregroundColor: WidgetStatePropertyAll(colorOnPrimary),
